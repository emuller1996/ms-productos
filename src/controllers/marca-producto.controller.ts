...
export class MarcaProductoController {
  ...
  async find(
    ...
    return this.marcaRepository.RL_PRODUCTOS(id).find(filter);
  }
  ...
  async create(
    ...
    return this.marcaRepository.RL_PRODUCTOS(id).create(producto);
  }
  ...
  async patch(
    ...
    return this.marcaRepository.RL_PRODUCTOS(id).patch(producto, where);
  }
  ...
  async delete(
    ...
    return this.marcaRepository.RL_PRODUCTOS(id).delete(where);
  }
}
