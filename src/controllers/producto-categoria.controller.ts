...
export class ProductoCategoriaController {
  ...
  async find(
    ...
    return this.productoRepository.RL_CATEGORIAS(id).find(filter);
  }
  ...
  async create(
    ...
    return this.productoRepository.RL_CATEGORIAS(id).create(categoria);
  }
  ...
  async patch(
    ...
    return this.productoRepository.RL_CATEGORIAS(id).patch(categoria, where);
  }
  ...
  async delete(
    ...
    return this.productoRepository.RL_CATEGORIAS(id).delete(where);
  }
}
