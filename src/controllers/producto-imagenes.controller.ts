...
export class ProductoImagenesController {
  ...
  async find(
    ...
    return this.productoRepository.imagenesRL(id).find(filter);
  }
  ...
  async create(
    ...
    return this.productoRepository.imagenesRL(id).create(imagenes);
  }
  ...
  async patch(
    ...
    return this.productoRepository.imagenesRL(id).patch(imagenes, where);
  }
  ...
  async delete(
    ...
    return this.productoRepository.imagenesRL(id).delete(where);
  }
}
